...
let merchantUserAccountActions = require('../action/merchantUserAccountActions')
let Utils = require('../../../../public/script/utils')
import Common from '../../../../public/script/common'

let merchantUserAccountStore = Reflux.createStore({
  listenables: [merchantUserAccountActions],
  filter: {},
  recordSet: [],
  startPage: 0,
  pageRow: 0,
...
module.exports = merchantUserAccountStore